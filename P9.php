<!-- Write a PHP script to display Number in words. Design HTML page to accept number. -->

<html>
<head>
	<title>PHP Program To convert given number into words</title>
</head>
<body>
	<form method="post">
		<table border="0">
			<tr>
				<td> <input type="text" name="num" value="" placeholder="Enter positive number"/> </td>
			</tr>
			<tr>
